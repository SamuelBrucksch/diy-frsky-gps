...
CustomFrSkySportSensorGps::CustomFrSkySportSensorGps(SensorId id) : FrSkySportSensor(id) { }

void CustomFrSkySportSensorGps::setData(float lat, float lon, float alt, float speed, float cog, uint8_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t minute, uint8_t second)
{
...
uint32_t CustomFrSkySportSensorGps::setLatLon(float latLon, bool isLat)
{
...
uint32_t CustomFrSkySportSensorGps::setDateTime(uint8_t yearOrHour, uint8_t monthOrMinute, uint8_t dayOrSecond, bool isDate)
{
...
void CustomFrSkySportSensorGps::send(FrSkySportSingleWireSerial& serial, uint8_t id, uint32_t now)
{
  if(sensorId == id)
  {
...
uint16_t CustomFrSkySportSensorGps::decodeData(uint8_t id, uint16_t appId, uint32_t data)
{
...
float CustomFrSkySportSensorGps::getLat() { return lat; }
float CustomFrSkySportSensorGps::getLon() { return lon; }
float CustomFrSkySportSensorGps::getAltitude() { return altitude; }
float CustomFrSkySportSensorGps::getSpeed() { return speed; }
float CustomFrSkySportSensorGps::getCog() { return cog; }
uint8_t CustomFrSkySportSensorGps::getYear() { return year; }
uint8_t CustomFrSkySportSensorGps::getMonth() { return month; }
uint8_t CustomFrSkySportSensorGps::getDay() { return day; }
uint8_t CustomFrSkySportSensorGps::getHour() { return hour; }
uint8_t CustomFrSkySportSensorGps::getMinute() { return minute; }
uint8_t CustomFrSkySportSensorGps::getSecond() { return second; }
#endif
